...
var RandomAssignmentService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.RandomAssignmentService = void 0;
const common_1 = require("@nestjs/common");
let RandomAssignmentService = RandomAssignmentService_1 = class RandomAssignmentService {
    constructor() {
        this.logger = new common_1.Logger(RandomAssignmentService_1.name);
    }
    draw(candidates, constraints = [], preAssignments = []) {
        ...
        for (let run = 0; run < maxRuns; run++) {
            ...
            while (Object.keys(assignments).length !== candidates.length) {
                const donorsToAssign = candidates.filter((candidate) => !Object.keys(assignments).includes(candidate));
                if (donorsToAssign.length === 0)
                    break;
                ...
                const doneesToAssign = candidates.filter((candidate) => candidate !== donorId &&
...
exports.RandomAssignmentService = RandomAssignmentService;
exports.RandomAssignmentService = RandomAssignmentService = RandomAssignmentService_1 = __decorate([
    (0, common_1.Injectable)()
], RandomAssignmentService);
//# sourceMappingURL=random-assignment.service.js.map